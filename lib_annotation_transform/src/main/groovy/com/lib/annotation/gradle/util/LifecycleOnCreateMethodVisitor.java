...
public class LifecycleOnCreateMethodVisitor extends MethodVisitor implements Opcodes {
    ...
    public void visitCode() {
        ...
        if (name.equals("<clinit>")) {
            ...
            mv.visitFieldInsn(PUTSTATIC, "com/study/doc/test/TestAsm", "TAG", "Ljava/lang/String;");
            mv.visitInsn(RETURN);
        } else {
            mv.visitMethodInsn(INVOKESTATIC, "com/study/doc/test/TestAsm", "showLog", "()V", false);
        }
    }
