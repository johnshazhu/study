    ...
    switch (route) {
      case "index":
        ...
        return MaterialApp(
          ...
          home: MyHomePage(title: wordPair.asCamelCase /*'Flutter Home Page'*/),
        );
...
class _MyAppBar extends AppBar {
  ...
  _MyAppBar({Key key, this.title, this.withAppBar = true}) : super(key: key);

  Widget _buildAppBar(BuildContext context) {
    if (this.withAppBar) {
      return new AppBar(title: this.title);
    }
